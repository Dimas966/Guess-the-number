Guess My Number GameThis is a simple web-based game built with HTML, CSS, and JavaScript where the player has to guess a random number between 1 and 10 within a limited number of attempts.
